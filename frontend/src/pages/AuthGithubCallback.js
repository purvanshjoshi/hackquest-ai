    ...
    useEffect(() => {
        const handleCallback = async () => {
            try {
                ...
                const response = await fetch(`${apiUrl}/api/auth/oauth/callback/github?code=${code}`, {
                    method: 'POST',
                });
                if (!response.ok) {
